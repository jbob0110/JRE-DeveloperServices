...
window.onload = () => {
    document.getElementById('BTNaddSubTasks').onclick = () => {
      ...
      if (project === 'DFDW' && gIssueType !== 'Spike' && gAlignTeam !== 'DW: Andromeda') {
        if (gComp !== 'None') {
          addSubTask({
            "fields":{  
              "project":{  "key": project },
          ...
          if (gIssueType !== 'Spike') {
            if (gAlignTeam !== 'DW: Andromeda') {
              if (gComp === 'None') {
                ...
                console.log("DFDW Story No Component");
              };
            };
          };
      } else if (project !== 'DFDW') {
          if (gIssueType !== 'Spike') {
            addSubTask({
              "fields":{  
                "project":{  "key": project },
            ...
            console.log("Non-DFDW Story");
          };
      } else if (project === 'DFDW' && gAlignTeam === 'DW: Andromeda' && gIssueType !== 'Spike' && gComp !== 'None') {
      addSubTask(
        {"fields":{  
          "project":{  "key": project },
          "parent":{ "key": jiraKey},
      ...
      console.log("Andromeda Spike W/ Component");
    } else if (project === 'DFDW' && gAlignTeam === 'DW: Andromeda' && gIssueType === 'Spike' && gComp === 'None') {
      addSubTask({
        "fields":{
          "project": { "key": project },
      ...
      console.log("Andromeda Spike No Component");
    };
  };
};
...
function addSubTask(subtask){
  ...
  xhr.open("POST", "https://"+jiraInstance+".cerner.com/rest/api/2/issue/", false);
